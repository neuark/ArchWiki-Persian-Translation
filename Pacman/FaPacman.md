...
Pactree
note > pactree(8) دیگر بخشی از بسته pacman نیست. در عوض میتوان آن را در pacman-contrib یافت.
...
برای مشاهده لیست درختی وابسته یک بسته، پرچم معکوس -r را به pactree منتقل کنید.
...
پک-من ذخیره میکند بسته های دانلود شده را در /var/cache/pacman/pkg/ و نسخه های قدیمی یا حذف شده را به طور خودکار حذف نمی کند. این کار مزایایی دارد:
